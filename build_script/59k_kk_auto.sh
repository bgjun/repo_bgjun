...
MODEL=59K_KK_EF
WORKSPACE=~/workspace
PROJECT=$WORKSPACE/59K_KK
BUILD_SHELL_PATH=$PROJECT/MSM8974_KK
LOG_DIR=~/log
PDL_DIR=~/pdl
PDL_MODEL_DIR=$PDL_DIR/$MODEL
LOG_MODEL_DIR=$LOG_DIR/$MODEL
LOG_FILE=$LOG_MODEL_DIR/build_log.txt
PROJECT_PDL_PATH=$BUILD_SHELL_PATH/tools/pdl
...
mv -f $PROJECT_PDL_PATH/*.pdl $PDL_MODEL_DIR/
rm -f $LOG_FILE
